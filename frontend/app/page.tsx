...
export default function HomePage() {
  return (
    <PublicPageShell>
      <div className="bg-white font-sans text-slate-800 selection:bg-blue-100 selection:text-blue-900">
        
        {/* 1. Hero Section With Gradient Fallback - FULL SCREEN */}
        {/* Hero background currently uses gradient fallback because /images/roadtierbers-hero.jpg was not found. */}
        <section className="relative min-h-[100svh] flex flex-col justify-center pt-24 pb-12 overflow-hidden bg-[#0B1F3A]">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full mt-8 lg:mt-0">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
              
              {/* Left Side: Copy & CTA */}
              <div className="text-center lg:text-left">
                <ScrollReveal delay={0}>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-900/50 border border-blue-700/50 text-blue-200 font-bold text-xs uppercase tracking-widest mb-6 backdrop-blur-sm">
                ...
                <ScrollReveal delay={0.3}>
                  <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                    <Link
                      ...
                      className="flex items-center justify-center gap-2 h-14 px-8 w-full sm:w-auto rounded-full bg-white text-[#0B1F3A] font-bold text-sm hover:bg-blue-50 hover:scale-[1.02] active:scale-95 transition-all shadow-lg"
                    >
              ...
              <div className="relative mx-auto w-full max-w-md lg:max-w-none lg:ml-auto">
                <ScrollReveal delay={0.4} direction="left">
                  <div className="relative bg-[#102A4C]/80 backdrop-blur-xl border border-blue-800/50 rounded-3xl p-6 shadow-2xl overflow-hidden group hover:border-blue-700/50 transition-colors">
                    ...
                    <div className="space-y-3">
                      {/* Status Item */}
                      <div className="bg-[#0B1F3A]/60 p-4 rounded-2xl border border-blue-900/50 flex items-center justify-between hover:bg-[#0B1F3A] hover:border-blue-700 transition-all duration-300">
                        ...
                        <div className="w-2 h-2 rounded-full bg-teal-400 shadow-[0_0_8px_#2dd4bf] animate-pulse" />
                      </div>
        ...
        <section className="py-24 lg:py-32 bg-slate-50 relative">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Masyarakat Panel */}
              <ScrollReveal delay={0.1}>
                <div className="bg-white p-8 lg:p-10 rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group h-full">
        ...
        <section className="py-24 lg:py-32 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <ScrollReveal>
              <h2 className="text-3xl lg:text-4xl font-extrabold text-[#0B1F3A] mb-12 text-center lg:text-left">Fitur Utama</h2>
            </ScrollReveal>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <ScrollReveal key={i} delay={i * 0.1}>
                  <Link href={feature.href} className="group block p-6 h-full rounded-3xl border border-slate-100 bg-white hover:border-blue-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <p className="text-sm text-slate-500 font-medium mb-6">{feature.desc}</p>
                    <div className="flex items-center text-xs font-bold text-blue-600 mt-auto">
        ...
        <section className="py-24 lg:py-32 relative overflow-hidden bg-gradient-to-b from-slate-50 to-white">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[300px] bg-blue-100/50 blur-[100px] pointer-events-none rounded-full" />
          
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <ScrollReveal>
              <h2 className="text-3xl lg:text-4xl font-extrabold text-[#0B1F3A] text-center mb-16">Bagaimana Sistem Bekerja</h2>
            </ScrollReveal>
            ...
            <div className="relative">
              ...
              <div className="lg:hidden absolute top-8 bottom-8 left-8 w-0.5 bg-slate-200" />
              ...
              <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-4 relative">
                {[
                  ...
                  <ScrollReveal key={i} delay={i * 0.1} className="w-full lg:w-auto">
                    <div className="flex lg:flex-col items-center lg:text-center gap-6 lg:gap-4 group relative z-10">
                      <div className="w-16 h-16 rounded-full bg-white border-4 border-slate-100 flex items-center justify-center shrink-0 group-hover:border-blue-200 group-hover:bg-blue-50 transition-colors duration-300 shadow-sm group-hover:shadow-md">
                        <item.icon className="w-6 h-6 text-slate-400 group-hover:text-blue-600 transition-colors" />
                      </div>
                      <div className="flex-1 lg:flex-none">
                        <h3 className="text-base font-bold text-[#0B1F3A] mb-1">{item.title}</h3>
                        <p className="text-xs text-slate-500 font-medium lg:max-w-[180px] lg:mx-auto">{item.desc}</p>
                      </div>
                    </div>
                  </ScrollReveal>
                ))}
        ...
        <section className="py-24 lg:py-32 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            <ScrollReveal>
              <h2 className="text-3xl lg:text-4xl font-extrabold text-[#0B1F3A] mb-4">Dibangun dengan Integrasi Model Deep Learning</h2>
            ...
            <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto mb-12">
              {[
                ...
                <ScrollReveal key={i} delay={i * 0.05} direction="none">
                  <div className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-slate-50 border border-slate-200 hover:border-blue-300 hover:bg-blue-50 hover:-translate-y-0.5 transition-all cursor-default shadow-sm hover:shadow-md">
            ...
            <ScrollReveal delay={0.4}>
              <Link href="/about" className="inline-flex items-center justify-center gap-2 text-blue-600 font-bold hover:text-blue-800 hover:bg-blue-50 px-6 py-3 rounded-full transition-colors group">
        ...
        <section className="py-24 bg-[#0B1F3A] relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
            <ScrollReveal>
              <h2 className="text-3xl lg:text-4xl font-extrabold text-white mb-6">Mulai dari pantauan jalan terdekat</h2>
              <p className="text-blue-100/80 font-medium mb-10 max-w-xl mx-auto text-lg leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  href="/traffic-overview"
                  className="flex items-center justify-center h-14 px-8 w-full sm:w-auto rounded-full bg-white text-[#0B1F3A] font-bold text-sm hover:bg-blue-50 hover:scale-[1.02] active:scale-95 transition-all shadow-lg"
                >
                  Buka Pantauan Lalu Lintas
                </Link>
                <Link
                  href="/about"
                  className="flex items-center justify-center h-14 px-8 w-full sm:w-auto rounded-full border border-blue-700 bg-transparent text-white font-bold text-sm hover:bg-blue-900/50 hover:border-blue-500 active:scale-95 transition-all"
                >
                  Pelajari Sistem
                </Link>
              </div>
        ...
        {/* 7. Evaluation Note */}
        <section className="py-8 bg-[#071529] border-t border-blue-900/50">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            <p className="text-[11px] sm:text-xs text-blue-300/50 font-medium max-w-3xl mx-auto leading-relaxed">
